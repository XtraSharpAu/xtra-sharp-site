...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Thank You | Xtra Sharp Campbelltown NSW",
    description: "Your message to Xtra Sharp has been received.",
    url: "https://www.xtrasharp.com.au/thank-you",
    type: "article",
    images: ["https://www.xtrasharp.com.au/og-thank-you.jpg"],
  },
  twitter: {
  ...
  other: {
    "twitter:url": "https://www.xtrasharp.com.au/thank-you",
  },
  alternates: {
    canonical: "https://www.xtrasharp.com.au/thank-you",
  },
  robots: {
    index: false,
    follow: true,
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { name: "Thank You", url: "https://www.xtrasharp.com.au/thank-you" },
        ]}
      />
