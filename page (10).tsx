...
export const metadata: Metadata = {
  title: "How It Works – Xtra Sharp Sharpening Process",
  description:
    "Simple sharpening process with clear steps, fast turnaround, and appointment-only drop-off in Woodbine NSW.",
};
